...
export function SolutionSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Increase end from +=800 to +=1500 for the added hero glamour sequence.
      ...
      tl.to(textRef.current, { opacity: 1, y: 0, duration: 1, ease: 'power2.out' })
        ...
        .to({}, { duration: 2 }); // Final hold before unpinning to Disassemble section
  ...
  return (
    <section ref={containerRef} className="h-screen w-full relative z-10 flex items-center overflow-hidden bg-[#050b14]">
      ...
      <div ref={textContainerRef} className="w-full md:w-1/3 px-6 md:pl-20 z-20 flex flex-col justify-center">
        <h2 ref={textRef} className="text-3xl md:text-4xl text-slate-400 font-light mb-4">
      ...
      >
        <div ref={glowRef} className="absolute w-[800px] h-[800px] rounded-full bg-[radial-gradient(circle,_rgba(53,209,218,0.25)_0%,_transparent_70%)] blur-2xl" />
        <img 
          ref={imgRef}
