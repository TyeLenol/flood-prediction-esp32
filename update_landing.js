    ...
    <main className="min-h-screen bg-slate-50 dark:bg-[#050b14] text-slate-700 dark:text-slate-300 font-sans selection:bg-teal-500/30 selection:text-teal-900 dark:selection:text-teal-200 overflow-x-hidden transition-colors duration-500">
      ...
      <section className="py-24 px-6 bg-slate-100 dark:bg-[#0a1420] transition-colors duration-500">
        <div className="max-w-6xl mx-auto">
          {/* Tabs */}
          <div ref={addToFadeRefs} className="flex flex-wrap items-center justify-center gap-2 mb-16 border-b border-slate-200 dark:border-slate-800 pb-4">
            {TABS.map((tab) => (
              <button
                key={tab.id}
                ...
                className={\`px-6 py-3 rounded-full text-sm font-medium transition-colors duration-300 \${
                  activeTab === tab.id 
                    ...
                    : 'text-slate-500 hover:text-slate-900 hover:bg-slate-200 dark:hover:text-slate-300 dark:hover:bg-slate-800/50'
                }\`}
              >
                {tab.label}
              </button>
          ...
          <div className="relative min-h-[500px]">
            ...
            <div className={\`absolute inset-0 transition-opacity duration-500 \${
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 h-full">
                <div className="lg:col-span-3 bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 flex flex-col justify-between overflow-hidden shadow-sm dark:shadow-none">
                  <div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  <div className="bg-white dark:bg-slate-800/40 rounded-2xl border border-slate-200 dark:border-slate-800 p-8 h-[calc(50%-12px)] flex flex-col justify-center shadow-sm dark:shadow-none">
      ...
      <section className="py-40 px-6 flex flex-col items-center text-center border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={addToFadeRefs} className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <MagneticButton>
              <a href="https://github.com/TyeLenol/flood-prediction-esp32" target="_blank" rel="noopener noreferrer" className="px-10 py-5 text-lg font-medium text-slate-700 bg-slate-200 hover:bg-slate-300 dark:text-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 rounded-full transition-colors duration-300 flex items-center gap-2">
...
console.log('LandingPage.tsx completely updated with day/night mode and new Circuit UI!');
